package cn.iocoder.teach-ai.module.system.service.social;
...
import cn.iocoder.teach-ai.framework.common.util.cache.CacheUtils;
import cn.iocoder.teach-ai.framework.common.util.http.HttpUtils;
import cn.iocoder.teach-ai.framework.common.util.object.BeanUtils;
import cn.iocoder.teach-ai.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import cn.iocoder.teach-ai.module.system.api.social.dto.SocialWxaOrderNotifyConfirmReceiveReqDTO;
import cn.iocoder.teach-ai.module.system.api.social.dto.SocialWxaOrderUploadShippingInfoReqDTO;
import cn.iocoder.teach-ai.module.system.api.social.dto.SocialWxaSubscribeMessageSendReqDTO;
import cn.iocoder.teach-ai.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import cn.iocoder.teach-ai.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import cn.iocoder.teach-ai.module.system.dal.dataobject.social.SocialClientDO;
import cn.iocoder.teach-ai.module.system.dal.mysql.social.SocialClientMapper;
import cn.iocoder.teach-ai.module.system.dal.redis.RedisKeyConstants;
import cn.iocoder.teach-ai.module.system.enums.social.SocialTypeEnum;
import cn.iocoder.teach-ai.module.system.framework.justauth.core.AuthRequestFactory;
...
import static cn.iocoder.teach-ai.framework.common.util.collection.MapUtils.findAndThen;
import static cn.iocoder.teach-ai.framework.common.util.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
import static cn.iocoder.teach-ai.framework.common.util.date.LocalDateTimeUtils.toEpochSecond;
import static cn.iocoder.teach-ai.framework.common.util.json.JsonUtils.toJsonString;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${teach-ai.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${teach-ai.wxa-subscribe-message.miniprogram-state:formal}")
    ...
    public void uploadWxaOrderShippingInfo(Integer userType, SocialWxaOrderUploadShippingInfoReqDTO reqDTO) {
        ...
        // 对应 ISSUE：https://gitee.com/zhijiantianya/teach-ai-cloud/pulls/230
