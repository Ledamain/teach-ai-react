package cn.iocoder.teach-ai.module.system.controller.admin.sms.vo.template;
...
public class SmsTemplateRespVO {
    ...
    @Schema(description = "模板名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "teach-ai")
    @ExcelProperty("模板名称")
    private String name;
