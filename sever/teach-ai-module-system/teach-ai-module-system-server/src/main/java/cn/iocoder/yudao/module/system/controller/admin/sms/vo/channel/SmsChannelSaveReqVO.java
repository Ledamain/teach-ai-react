package cn.iocoder.teach-ai.module.system.controller.admin.sms.vo.channel;
...
public class SmsChannelSaveReqVO {
    ...
    @Schema(description = "短信 API 的账号", requiredMode = Schema.RequiredMode.REQUIRED, example = "teach-ai")
