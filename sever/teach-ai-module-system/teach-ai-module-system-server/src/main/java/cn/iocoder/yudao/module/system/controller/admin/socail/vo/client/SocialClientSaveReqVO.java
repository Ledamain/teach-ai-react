package cn.iocoder.teach-ai.module.system.controller.admin.socail.vo.client;
...
import cn.iocoder.teach-ai.framework.common.validation.InEnum;
...
public class SocialClientSaveReqVO {
    ...
    @Schema(description = "应用名", requiredMode = Schema.RequiredMode.REQUIRED, example = "teach-ai商城")
