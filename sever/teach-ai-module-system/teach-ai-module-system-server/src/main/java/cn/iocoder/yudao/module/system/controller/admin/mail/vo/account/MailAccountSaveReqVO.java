package cn.iocoder.teach-ai.module.system.controller.admin.mail.vo.account;
...
public class MailAccountSaveReqVO {
    ...
    @Schema(description = "邮箱", requiredMode = Schema.RequiredMode.REQUIRED, example = "teach-aiyuanma@123.com")
    @NotNull(message = "邮箱不能为空")
    @Email(message = "必须是 Email 格式")
    private String mail;

    @Schema(description = "用户名", requiredMode = Schema.RequiredMode.REQUIRED, example = "teach-ai")
