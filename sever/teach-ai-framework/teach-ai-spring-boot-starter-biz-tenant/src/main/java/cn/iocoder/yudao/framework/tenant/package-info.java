 ...
 *      1）Spring Async：
 *          {@link cn.iocoder.teach-ai.framework.quartz.config.YudaoAsyncAutoConfiguration#threadPoolTaskExecutorBeanPostProcessor()}
 *      2）Spring Security：
 ...
 *
 */
package cn.iocoder.teach-ai.framework.tenant;
