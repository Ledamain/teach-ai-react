package cn.iocoder.teach-ai.framework.tracer.config;

import cn.iocoder.teach-ai.framework.common.enums.WebFilterOrderEnum;
import cn.iocoder.teach-ai.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "teach-ai.tracer", value = "enable", matchIfMissing = true)
