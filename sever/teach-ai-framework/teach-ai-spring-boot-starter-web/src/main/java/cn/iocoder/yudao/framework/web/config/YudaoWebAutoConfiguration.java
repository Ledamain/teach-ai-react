package cn.iocoder.teach-ai.framework.web.config;
...
import cn.iocoder.teach-ai.framework.web.core.filter.CacheRequestBodyFilter;
import cn.iocoder.teach-ai.framework.web.core.filter.DemoFilter;
import cn.iocoder.teach-ai.framework.web.core.handler.GlobalExceptionHandler;
import cn.iocoder.teach-ai.framework.web.core.handler.GlobalResponseBodyHandler;
...
public class YudaoWebAutoConfiguration {
     ...
     */
    @Bean
    @ConditionalOnProperty(value = "teach-ai.demo", havingValue = "true")
