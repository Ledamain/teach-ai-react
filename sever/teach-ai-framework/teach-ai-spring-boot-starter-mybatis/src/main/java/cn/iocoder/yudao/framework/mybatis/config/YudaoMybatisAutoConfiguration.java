package cn.iocoder.teach-ai.framework.mybatis.config;

import cn.hutool.core.collection.CollUtil;
import cn.hutool.core.util.StrUtil;
import cn.iocoder.teach-ai.framework.common.util.json.JsonUtils;
import cn.iocoder.teach-ai.framework.mybatis.core.handler.DefaultDBFieldHandler;
...
@MapperScan(value = "${teach-ai.info.base-package}", annotationClass = Mapper.class,
