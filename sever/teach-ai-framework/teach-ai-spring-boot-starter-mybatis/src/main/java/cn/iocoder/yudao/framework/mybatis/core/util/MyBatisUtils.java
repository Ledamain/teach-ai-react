package cn.iocoder.teach-ai.framework.mybatis.core.util;
...
import cn.iocoder.teach-ai.framework.common.pojo.SortingField;
import cn.iocoder.teach-ai.framework.mybatis.core.enums.DbTypeEnum;
...
public class MyBatisUtils {
    ...
    public static <T> Page<T> buildPage(PageParam pageParam, Collection<SortingField> sortingFields) {
        ...
        page.setOptimizeJoinOfCountSql(false); // 关联 issue：https://gitee.com/zhijiantianya/teach-ai-cloud/issues/ID2QLL
        // 排序字段
